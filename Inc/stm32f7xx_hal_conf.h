...
#define USE_HAL_CRC_REGISTER_CALLBACKS 1U       /* CRC register callback disabled       */
...
/* Includes ------------------------------------------------------------------*/
/**
 * @brief Include low-level header file
 */
...
/* Exported macro ------------------------------------------------------------*/
   ...
   * @retval None
   */
#define assert_param(expr) ((expr) ? (void)0 : vAssertCalled(__LINE__, (uint8_t *)__FILE__))
#else

...
typedef struct  __CRC_HandleTypeDef
#else
typedef struct
#endif /* (USE_HAL_CRC_REGISTER_CALLBACKS) */
{
  ...
  uint32_t InputDataFormat;                /*!< This parameter is a value of @ref CRC_Input_Buffer_Format and specifies input data format.
                                          ...
                                          above  */
#if (USE_HAL_CRC_REGISTER_CALLBACKS == 1)
  void (* MspInitCallback)(struct __CRC_HandleTypeDef *hcrc);     /*!< CRC Msp Init callback      */
  void (* MspDeInitCallback)(struct __CRC_HandleTypeDef *hcrc);   /*!< CRC Msp DeInit callback    */
#endif /* USE_HAL_CRC_REGISTER_CALLBACKS */
...
#if (USE_HAL_CRC_REGISTER_CALLBACKS == 1)
/**
  * @brief  HAL CRC Callback ID enumeration definition
  */
typedef enum
{
  HAL_CRC_MSPINIT_CB_ID                 = 0x00U,     /*!< CRC MspInit callback ID        */
  HAL_CRC_MSPDEINIT_CB_ID               = 0x01U      /*!< CRC MspDeInit callback ID      */

} HAL_CRC_CallbackIDTypeDef;

/**
  * @brief  HAL CRC Callback pointer definition
  */
typedef  void (*pCRC_CallbackTypeDef)(CRC_HandleTypeDef *hcrc);   /*!< pointer to a common CRC callback function */
...
/** @brief Reset CRC handle state.
  ...
  */
#if (USE_HAL_CRC_REGISTER_CALLBACKS == 1)
#define __HAL_CRC_RESET_HANDLE_STATE(__HANDLE__)  do{                                                   \
